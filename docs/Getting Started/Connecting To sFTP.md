...
### Common Slip ups
Make sure you don't inadvertently enter the port twice. The connection will fail if you don't include the full address (including sftp://), username and password.
